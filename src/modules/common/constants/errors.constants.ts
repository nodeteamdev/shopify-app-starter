...
export const POKER_API_VALIDATION_ERROR = (
  errorText?: string,
): '400001: Poker API validation error' | `400001: ${string}` =>
  errorText
    ? `400001: ${errorText.replaceAll(':', '').replaceAll('ERROR', '').trim()}`
    : '400001: Poker API validation error';
...
export const POKER_API_CONFIG_NOT_FOUND = '404001: Poker API Config Not found';

export const POKER_API_RATE_LIMIT_NOT_FOUND =
  '404002: Poker API Rate Limit Not found';
...
export const DEFAULT_POKER_QUERY_PARAMS_ERROR = (
  errorText?: string,
): '500001: Invalid Default Poker Query Params' | `500001: ${string}` =>
  errorText
    ? `500001: ${errorText.replaceAll(':', '').replaceAll('ERROR', '').trim()}`
    : '500001: Invalid Default Poker Query Params';

export const INVALID_POKER_QUERY_TYPE = '500002: Invalid Poker Query Type';
...
export const POKER_API_NOT_AVAILABLE_ERROR =
  '503001: Poker API is not available';

export const TO_MANY_CONNECTIONS_TO_POKER_API =
  '503002: To many connections to the Poker API';

export const POKER_API_CONNECTIONS_LEAK = '503003: Poker API connections leak';
